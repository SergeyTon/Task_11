...
<body>
  ...
  <div>
    ...
    <span>
      ...
      Гибкое сравнение - сначала значения преобразовываются к одному типу и тогда уже сравниваются,<br> например, строка "1" будет равна числу 1 или булевому true, также как false равно 0 или null.<br>
